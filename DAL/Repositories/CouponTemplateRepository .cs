...
namespace DAL.Repositories
{
    public class CouponTemplateRepository : ICouponTemplateRepository
    {
        ...
        public async Task<CouponTemplate> GetByIdAsync(int id)
        {
            return await _context.CouponTemplates
                .FirstOrDefaultAsync(ct => ct.Id == id);
        }

        public async Task<IEnumerable<CouponTemplate>> GetAllAsync()
        {
            return await _context.CouponTemplates
        ...
        public async Task<IEnumerable<CouponTemplate>> GetWithQueryAsync(CouponTemplateQueryParams queryParams)
        {
            ...
            {
                "name" => queryParams.SortDescending ? query.OrderByDescending(ct => ct.Name) : query.OrderBy(ct => ct.Name),
                "pointscost" => queryParams.SortDescending ? query.OrderByDescending(ct => ct.PointsCost) : query.OrderBy(ct => ct.PointsCost),
                "createdat" => queryParams.SortDescending ? query.OrderByDescending(ct => ct.CreatedAt) : query.OrderBy(ct => ct.CreatedAt),
                _ => queryParams.SortDescending ? query.OrderByDescending(ct => ct.Name) : query.OrderBy(ct => ct.Name)
            };
        ...
        public async Task<CouponTemplate> CreateAsync(CouponTemplate couponTemplate)
        {
        ...
        public async Task<CouponTemplate> UpdateAsync(CouponTemplate couponTemplate)
        {
