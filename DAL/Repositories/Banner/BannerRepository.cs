...
namespace DAL.Repositories.Banner
{
    public class BannerRepository : IBannerRepository
    {
        ...
        public async Task<BannerModel> GetByIdAsync(int id, bool includeRelations = false)
        {
        ...
        public async Task<IEnumerable<BannerModel>> GetAllAsync()
        {
            return await _context
                .Banners.Include(b => b.Creator)
                .OrderBy(b => b.Position)
                .ThenBy(b => b.SortOrder)
                .ToListAsync();
        }

        public async Task<IEnumerable<BannerModel>> GetWithQueryAsync(BannerQueryParams queryParams)
        {
            var query = _context.Banners.Include(b => b.Creator).AsQueryable();
        ...
        public async Task<BannerModel> CreateAsync(BannerModel banner)
        {
            ...
            await _context.Entry(banner).Reference(b => b.Creator).LoadAsync();
        ...
        public async Task<BannerModel> UpdateAsync(BannerModel banner)
        {
            ...
            // Load creator information
            await _context.Entry(existingBanner).Reference(b => b.Creator).LoadAsync();
        ...
        public async Task<IEnumerable<BannerModel>> GetBannersByPositionAsync(string position)
        {
            return await _context
                .Banners.Include(b => b.Creator)
        ...
        public async Task<IEnumerable<BannerModel>> GetActiveBannersByPositionAsync(string position)
        {
            var now = DateTime.Now;
        ...
        {
            var maxSort = await _context
                .Banners.Where(b => b.Position.ToString() == position)
