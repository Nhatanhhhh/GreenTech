...
namespace DAL.Repositories.Category
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        public async Task<CategoryModel> GetByIdAsync(int id, bool includeRelations = false)
        {
        ...
        public async Task<IEnumerable<CategoryModel>> GetWithQueryAsync(
        ...
        {
            return await _context
                .Categories.Where(c => c.ParentId == null && c.IsActive)
                .Include(c => c.SubCategories)
                .Include(c => c.Products)
                .OrderBy(c => c.SortOrder)
                .ThenBy(c => c.Name)
        ...
        public async Task<IEnumerable<CategoryModel>> GetSubCategoriesAsync(int parentId)
        {
            return await _context
                .Categories.Where(c => c.ParentId == parentId && c.IsActive)
                .Include(c => c.Products)
                .OrderBy(c => c.SortOrder)
                .ThenBy(c => c.Name)
                .ToListAsync();
        ...
        public async Task<IEnumerable<CategoryModel>> GetCategoryTreeAsync()
        {
            return await _context
