        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cancelled_reason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    media_urls = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, "Tưới nước đều đặn, tránh úng. Cần ánh sáng đầy đủ, bón phân định kỳ để cây ra hoa nhiều. Cắt tỉa sau mỗi đợt hoa.", 2, 400000m, new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), "Cây Hoa Giấy (Bougainvillea) là loại cây leo có hoa đẹp rực rỡ, nhiều màu sắc. Cây thích hợp trồng ngoài trời, chịu nắng tốt, dễ chăm sóc và có thể cắt tỉa tạo dáng đẹp.", "Chậu 30cm", "https://res.cloudinary.com/dvsqjznt2/image/upload/v1761983435/cay-hoa-giay-canh-nhieu-mau_gpageh.jpg", true, true, "Cây Hoa Giấy", "Trung bình (80-120cm)", 30, 40, 300000m, "Cây Hoa Giấy đẹp rực rỡ, nhiều màu, dễ trồng ngoài trời. Phù hợp trang trí sân vườn, ban công.", "Mua Cây Hoa Giấy - Cây Leo Đẹp, Nhiều Màu Sắc", "Cây hoa giấy đẹp rực rỡ, trồng ngoài trời.", "CHG005", "cay-hoa-giay", 1, "cay-ngoai-troi,hoa-dep,leo,trang-tri", new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), 5.0m },
                    { 6, "Cần ánh sáng đầy đủ, tưới nước vừa phải. Bón phân định kỳ. Cắt tỉa sau Tết để cây phát triển tốt. Cần chăm sóc đặc biệt trước Tết để hoa nở đúng thời điểm.", 2, 800000m, new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), "Cây Mai Vàng (Ochna integerrima) là loại cây cảnh truyền thống của Việt Nam, đặc biệt phổ biến vào dịp Tết. Cây có hoa vàng đẹp, mang ý nghĩa may mắn, tài lộc.", "Chậu 40cm", "https://res.cloudinary.com/dvsqjznt2/image/upload/v1761983794/cay-hoa-mai-vang_qhbl3q.jpg", true, true, "Cây Mai Vàng", "Lớn (100-150cm)", 60, 25, 600000m, "Cây Mai Vàng đẹp, hợp phong thủy, chưng Tết truyền thống. Mang lại may mắn, tài lộc cho gia đình.", "Mua Cây Mai Vàng - Chưng Tết, Mang May Mắn", "Cây mai vàng truyền thống, chưng Tết.", "CMV006", "cay-mai-vang", 2, "cay-ngoai-troi,mai-vang,tet,phong-thuy", new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), 8.0m },
                    { 7, "Tưới nước thường xuyên, đặc biệt vào mùa khô. Cần ánh sáng đầy đủ hoặc bán bóng. Bón phân hữu cơ định kỳ. Cắt bỏ lá già để cây đẹp hơn.", 2, 500000m, new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), "Cây Chuối Cảnh (Musa spp.) có lá to, xanh mướt tạo cảnh quan nhiệt đới đẹp mắt. Cây phù hợp trồng ngoài sân vườn, tạo điểm nhấn cho không gian xanh.", "Chậu 50cm", "https://res.cloudinary.com/dvsqjznt2/image/upload/v1761984589/hoa-lua-180-366280e2-3c49-4bba-8f3f-c9a9cb3cda71_l5tzes.jpg", true, false, "Cây Chuối Cảnh", "Lớn (120-180cm)", 35, 35, 350000m, "Cây Chuối Cảnh đẹp, xanh mướt, phù hợp trang trí sân vườn. Tạo không gian nhiệt đới sinh động.", "Cây Chuối Cảnh - Tạo Không Gian Nhiệt Đới Xanh Mát", "Cây chuối cảnh nhiệt đới, xanh mát.", "CCC007", "cay-chuoi-canh", 3, "cay-ngoai-troi,nhiet-doi,xanh-mat,trang-tri-san", new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), 10.0m },
                    { 8, "Tưới nước đều đặn, không để khô hoàn toàn. Cần ánh sáng tốt. Bón phân định kỳ. Kiểm soát sâu bệnh đặc biệt là mối. Cắt tỉa thân già để cây trẻ đẹp hơn.", 2, 450000m, new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), "Cây Tre Cảnh (Bambusa spp.) mang vẻ đẹp thanh tao, cổ điển. Theo phong thủy, tre mang lại may mắn, thịnh vượng và bảo vệ gia đình. Cây dễ trồng, chịu được nhiều điều kiện khí hậu.", "Chậu 35cm", "https://res.cloudinary.com/dvsqjznt2/image/upload/v1761984743/cay-tre-3-638371520309931454_mgmsko.webp", true, false, "Cây Tre Cảnh", "Trung bình (100-150cm)", 32, 30, 320000m, "Cây Tre Cảnh đẹp thanh tao, hợp phong thủy. Mang lại may mắn, thịnh vượng cho gia đình. Dễ trồng, dễ chăm sóc.", "Cây Tre Cảnh - Phong Thủy, Thanh Tao, May Mắn", "Tre cảnh thanh tao, phong thủy tốt.", "CTC008", "cay-tre-canh", 1, "cay-ngoai-troi,tre-canh,phong-thuy,thanh-tao", new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), 7.0m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, "Hoa giấy nhiều màu sắc", new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), "https://res.cloudinary.com/dvsqjznt2/image/upload/v1761983631/hoa-giay-5_p7inkl.jpg", false, 5, 1 },
                    { 7, "Cây mai vàng nở hoa", new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), "https://res.cloudinary.com/dvsqjznt2/image/upload/v1761986192/A_CC_89nh-C_C3_A2y-Mai-300x300_fey4bn.jpg", false, 6, 1 },
                    { 8, "Chuối cảnh trang trí sân vườn", new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), "https://res.cloudinary.com/dvsqjznt2/image/upload/v1761984662/chuoi-canh3jpg_vbbfsa.jpg", false, 7, 1 },
                    { 9, "Tre cảnh thanh tao", new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), "https://res.cloudinary.com/dvsqjznt2/image/upload/v1761984792/cay-tre-canh_grande_b49xkr.jpg", false, 8, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, 0m, new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), 0, 0, 0, 0, 0, 0, 0, 0 },
                    { 6, 0m, new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), 0, 0, 0, 0, 0, 0, 0, 0 },
                    { 7, 0m, new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), 0, 0, 0, 0, 0, 0, 0, 0 },
                    { 8, 0m, new DateTime(2025, 10, 28, 3, 25, 6, 233, DateTimeKind.Utc), 0, 0, 0, 0, 0, 0, 0, 0 }
                });
