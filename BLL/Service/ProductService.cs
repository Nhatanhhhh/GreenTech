...
namespace BLL.Service
{
    public class ProductService : IProductService
    {
        ...
        public async Task DeleteImageAsync(int productId, int imageId)
        {
            ...
            {
                throw new KeyNotFoundException($"Image with ID {imageId} not found for this product.");
            }
        ...
        public async Task<IEnumerable<ProductResponseDTO>> GetProductsAsync(ProductQueryParamsDTO queryParams)
        {
        ...
        public async Task<List<ProductImageDTO>> UploadImagesAsync(int productId, List<IFormFile> files)
        {
            var product = await _productRepository.GetByIdAsync(productId);
            if (product == null)
            {
